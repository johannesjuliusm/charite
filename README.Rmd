...
```{r example, warning=FALSE, message=FALSE, echo=FALSE, fig.align='center', fig.cap="Example plot generated with `example_plot( )`", out.width="50%"}
...
```{r preview, warning=FALSE, message=FALSE, echo=FALSE, fig.align='center', fig.cap="Colour palettes available with the `charite` package", out.width="50%"}
